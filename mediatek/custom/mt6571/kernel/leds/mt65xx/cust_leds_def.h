...
enum mt65xx_led_pmic
{
	...
	MT65XX_LED_PMIC_NLED_ISINK01,
        MT65XX_LED_PMIC_NLED_ISINK_GROUP_BEGIN = 100,
        MT65XX_LED_PMIC_NLED_ISINK_GROUP0 = MT65XX_LED_PMIC_NLED_ISINK_GROUP_BEGIN,
        MT65XX_LED_PMIC_NLED_ISINK_GROUP1,
        MT65XX_LED_PMIC_NLED_ISINK_GROUP2,
        MT65XX_LED_PMIC_NLED_ISINK_GROUP3,
        MT65XX_LED_PMIC_NLED_ISINK_GROUP_END,
     	MT65XX_LED_PMIC_LCD_ISINK_GROUP_BEGIN = 200,
     	MT65XX_LED_PMIC_LCD_ISINK_GROUP0 = MT65XX_LED_PMIC_LCD_ISINK_GROUP_BEGIN,     	
     	MT65XX_LED_PMIC_LCD_ISINK_GROUP1,
     	MT65XX_LED_PMIC_LCD_ISINK_GROUP2,
     	MT65XX_LED_PMIC_LCD_ISINK_GROUP3,
